...
def take_data():
    ...
    tinhName = listTinh3[14][0]
    tinhCode = listTinh3[14][1]
    while True:
        line = {}
...
def convert_to_csv(path):
    ...
    data_df.to_csv('C:/Users/Nguyen Dai Ky/Workspace/ML/CS114.L21-HA/DoAn/WildfireAPI.csv',index=None,encoding='utf-8-sig')

if __name__ == "__main__":
    take_data()
    # convert_to_csv('DataAPI.csv')
